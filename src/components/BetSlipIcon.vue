...
<template>
  <div
    v-if="game === 'SmartPlayKeno'"
    class="w-5 h-5 flex items-center justify-center absolute top-1.5 left-2 text-white"
  >
    <svg
      ...
      alt="SmartPlayKeno"
      src="/Content/Images/Icons/SmartPlayKenoIcon.svg"
    >
      <path
        class="cls-1"
