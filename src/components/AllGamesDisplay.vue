...
<template>
  <div class="w-32 h-2 bg-green-400 gap-2 p-2 flex items-center justify-center">
    <div
      @click="$emit('gameChnage', games)"
      class="cursor-pointer flex items-center gap-1 bg-black"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 47.53 51.97"
        data-svg-id="SpeedSkatingSVG"
        :class="`icon  hover:fill-[#37B34A] cursor-pointer w-7 ${
      ...
      <span class="uppercase">Speed skating</span>
    </div>
  </div>
</template>
